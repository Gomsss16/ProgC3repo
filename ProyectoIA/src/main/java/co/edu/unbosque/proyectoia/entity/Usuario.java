...
public class Usuario implements UserDetails {
    ...
    public Usuario(String correo, String contrasenia, boolean validarCodigo) {
        super();
        this.correo = correo;
    ...
    public Usuario(Long id, String nombre, String correo, String contrasenia, Role role, String codigoVerificacion,
            boolean validarCodigo) {
        super();
        this.id = id;
        this.nombre = nombre;
