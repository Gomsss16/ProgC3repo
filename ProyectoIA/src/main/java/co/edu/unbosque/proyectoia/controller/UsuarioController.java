...
//		  UsuarioDTO newUser = new UsuarioDTO(nombre, correo, null, false);
...
//	    public ResponseEntity<String> loginUsuario(@RequestBody AdministradorDTO loginRequest) {
...
//	            }
//	            
//	            int authResult = usuarioService.authenticateUsuario(loginRequest.getUsuario(), loginRequest.getContrasenia());
